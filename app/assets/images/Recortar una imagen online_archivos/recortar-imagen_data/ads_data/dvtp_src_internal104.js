...
window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,l("shapeOutside","content-box",!0));return b}catch(u){return 0}}function ma(){try{var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(e){}var d=0;c=function(b,c){c&&(d=(d|1<<b)>>>0)};c(14,b.playerInstance&&b.document.querySelector('script[src*="ads-player.com"]'));c(15,b.zpz&&b.zpz.createPlayer);c(15,b.vdApp&&b.vdApp.createPlayer);c(15,b.document.querySelector('body>div[class="z-z-z"]'));
c(16,b.xy_checksum&&b.place_player&&b.logjwonready&&b.logContentPauseRequested);c(17,b==b.top&&""==b.document.title?(a=b.document.querySelector('body>object[id="player"]'),a&&a.data&&1<a.data.indexOf("jwplayer")&&"visibility: visible;"==a.getAttribute("style")):!1);c(17,b.document.querySelector('script[src*="sitewebvideo.com"]'));c(17,b.InitPage&&b.cef&&b.InitAd);return d}catch(e){return 0}}function na(){function b(b){if(null==b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c=
"",d,f=7;0<=f;f--)d=b>>>4*f&15,c+=d.toString(16);return c},e=[1518500249,1859775393,2400959708,3395469782];b+=String.fromCharCode(128);for(var g=Math.ceil((b.length/4+2)/16),k=Array(g),r=0;r<g;r++){k[r]=Array(16);for(var v=0;16>v;v++)k[r][v]=b.charCodeAt(64*r+4*v)<<24|b.charCodeAt(64*r+4*v+1)<<16|b.charCodeAt(64*r+4*v+2)<<8|b.charCodeAt(64*r+4*v+3)}k[g-1][14]=8*(b.length-1)/Math.pow(2,32);k[g-1][14]=Math.floor(k[g-1][14]);k[g-1][15]=8*(b.length-1)&4294967295;b=1732584193;v=4023233417;var m=2562383102,
K=271733878,I=3285377520,E=Array(80);for(r=0;r<g;r++){for(var t=0;16>t;t++)E[t]=k[r][t];for(t=16;80>t;t++)E[t]=c(E[t-3]^E[t-8]^E[t-14]^E[t-16],1);var f=b;var z=v;var A=m;var y=K;var G=I;for(t=0;80>t;t++){var B=Math.floor(t/20),L=c(f,5);a:{switch(B){case 0:var M=z&A^~z&y;break a;case 1:M=z^A^y;break a;case 2:M=z&A^z&y^A&y;break a;case 3:M=z^A^y;break a}M=void 0}B=L+M+G+e[B]+E[t]&4294967295;G=y;y=A;A=c(z,30);z=f;f=B}b=b+f&4294967295;v=v+z&4294967295;m=m+A&4294967295;K=K+y&4294967295;I=I+G&4294967295}return d(b)+
d(v)+d(m)+d(K)+d(I)}function c(){try{return!!window.sessionStorage}catch(k){return!0}}function d(){try{return!!window.localStorage}catch(k){return!0}}function e(){var b=document.createElement("canvas");if(b.getContext&&b.getContext("2d")){var c=b.getContext("2d");c.textBaseline="top";c.font="14px 'Arial'";c.textBaseline="alphabetic";c.fillStyle="#f60";c.fillRect(0,0,62,20);c.fillStyle="#069";c.fillText("!image!",2,15);c.fillStyle="rgba(102, 204, 0, 0.7)";c.fillText("!image!",4,17);return b.toDataURL()}return null}
try{var g=[];g.push(["lang",navigator.language||navigator.browserLanguage]);g.push(["tz",(new Date).getTimezoneOffset()]);g.push(["hss",c()?"1":"0"]);g.push(["hls",d()?"1":"0"]);g.push(["odb",typeof window.openDatabase||""]);g.push(["cpu",navigator.cpuClass||""]);g.push(["pf",navigator.platform||""]);g.push(["dnt",navigator.doNotTrack||""]);g.push(["canv",e()]);return b(g.join("=!!!="))}catch(k){return null}}this.createRequest=function(){function b(b,c){var f={};try{if(b.performance&&b.performance.getEntries){var C=
b.performance.getEntries();for(b=0;b<C.length;b++){var e=C[b],g=e.name.match(/.*\/(.+?)\./);if(g&&g[1]){var h=g[1].replace(/\d+$/,""),k=c[h];if(k){for(var m=0;m<k.stats.length;m++){var l=k.stats[m];f[k.prefix+l.prefix]=Math.round(e[l.name])}delete c[h];if(!d(c))break}}}}return f}catch(qa){}}function c(c,f){var C;if(c.frames)for(var e=0;e<c.frames.length;e++)if((C=b(c.frames[e],f))&&d(C))return C}function d(b){var c=0,d;for(d in b)b.hasOwnProperty(d)&&++c;return c}function e(b){if(b&&d(b))for(var c in b)b.hasOwnProperty(c)&&
D.push(c+"="+b[c]);else D.push("dvp_noperf=1")}window._dv_win.$dv.isEval=1;window._dv_win.$dv.DebugInfo={};var g=!1,k=!1,p,n,h=!1,l=window._dv_win,u=0,r=!1,v=getCurrentTime();window._dv_win.t2tTimestampData=[{dvTagCreated:v}];var m;try{for(m=0;10>=m;m++)if(null!=l.parent&&l.parent!=l)if(0<l.parent.location.toString().length)l=l.parent,u++,h=!0;else{h=!1;break}else{0==m&&(h=!0);break}}catch(C){h=!1}0==l.document.referrer.length?m=l.location:h?m=l.location:(m=l.document.referrer,r=!0);var K="",I=null,
E=null;try{window._dv_win.external&&(I=void 0!=window._dv_win.external.QueuePageID?window._dv_win.external.QueuePageID:null,E=void 0!=window._dv_win.external.CrawlerUrl?window._dv_win.external.CrawlerUrl:null)}catch(C){K="&dvp_extErr=1"}if(!window._dv_win._dvScriptsInternal||!window._dv_win.dvProcessed||0==window._dv_win._dvScriptsInternal.length)return null;h=window._dv_win._dvScriptsInternal.pop();var t=h.script;this.dv_script_obj=h;this.dv_script=t;window._dv_win.t2tTimestampData[0].dvWrapperLoadTime=
h.loadtime;window._dv_win.dvProcessed.push(h);var f=t.src;this.dv_script_obj.dvSrc=f;void 0!=window._dv_win.$dv.CommonData.BrowserId&&void 0!=window._dv_win.$dv.CommonData.BrowserVersion&&void 0!=window._dv_win.$dv.CommonData.BrowserIdFromUserAgent?h={ID:window._dv_win.$dv.CommonData.BrowserId,version:window._dv_win.$dv.CommonData.BrowserVersion,ID_UA:window._dv_win.$dv.CommonData.BrowserIdFromUserAgent}:(h=dv_GetParam(f,"useragent"),h=(new BrowserDetector).getBrowserIdAndVersion(h?decodeURIComponent(h):
navigator.userAgent),window._dv_win.$dv.CommonData.BrowserId=h.ID,window._dv_win.$dv.CommonData.BrowserVersion=h.version,window._dv_win.$dv.CommonData.BrowserIdFromUserAgent=h.ID_UA);var z=!0,A=window.parent.postMessage&&window.JSON,y=!1;if("0"==dv_GetParam(f,"t2te")||window._dv_win.dv_config&&!0===window._dv_win.dv_config.supressT2T)y=!0;if(A&&!1===y&&5!=window._dv_win.$dv.CommonData.BrowserId)try{var G=V(window._dv_win.dv_config.t2turl||"https://cdn3.doubleverify.com/t2tv7.html");z=Q(G)}catch(C){}window._dv_win.$dv.DebugInfo.dvp_HTML5=
A?"1":"0";var B=dv_GetParam(f,"region")||"",L=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream,M=L?"https:":aa(),N=L?"https:":ba(f);y="0";"https:"===N&&(y="1");try{l.depth=ia(l);var w=ja(l);dv_aUrlParam="&aUrl="+encodeURIComponent(w.url);dv_aUrlDepth="&aUrlD="+w.depth;dv_referrerDepth=l.depth+u;r&&l.depth--}catch(C){dv_aUrlDepth=dv_aUrlParam=dv_referrerDepth=l.depth=""}u=
dv_GetDynamicParams(f,"dvp");r=dv_GetDynamicParams(f,"dvpx");for(w=0;w<r.length;w++){var q=dv_GetKeyValue(r[w]);r[w]=q.key+"="+encodeURIComponent(q.value)}"41"==B&&(B=50>100*Math.random()?"41":"8",u.push("dvp_region="+B));u=u.join("&");r=r.join("&");B=window._dv_win.dv_config.tpsAddress||"tps"+B+".doubleverify.com";w="visit.js";switch(dv_GetParam(f,"dvapi")){case "1":w="dvvisit.js";break;case "5":w="query.js";break;default:w="visit.js"}window._dv_win.$dv.DebugInfo.dvp_API=w;var x="ctx cmp ipos sid plc adid crt btreg btadsrv adsrv advid num pid crtname unit chnl uid scusrid tagtype sr dt dup app dvvidver".split(" "),
D=[];for(q=0;q<x.length;q++){var J=dv_GetParam(f,x[q])||"";D.push(x[q]+"="+J);""!==J&&(window._dv_win.$dv.DebugInfo["dvp_"+x[q]]=J)}x="turl icall dv_callback useragent xff timecheck seltag sadv ord litm scrt invs splc adu native gmnpo".split(" ");for(q=0;q<x.length;q++)J=dv_GetParam(f,x[q]),null!=J&&D.push(x[q]+"="+(J||""));(q=dv_GetParam(f,"isdvvid")||"")&&D.push("isdvvid=1");x=dv_GetParam(f,"tagtype")||"";var H=window._dv_win.$dv.getMraid();a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var F=
!0;break a}}catch(C){}F=!1}J=ea(H,f);D.push("sup="+J);1==q||H||"video"!=x&&"1"!=x||(q=dv_GetParam(f,"adid")||"","function"===typeof _dv_win[q]&&(D.push("prplyd=1"),D.push("DVP_GVACB="+q),D.push("isdvvid=1")),q="AICB_"+(window._dv_win.dv_config&&window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():dv_GetRnd()),window._dv_win[q]=function(b){g=!0;p=b;window._dv_win.$dv&&1==k&&window._dv_win.$dv.registerEventCall(n,{prplyd:0,dvvidver:b})},D.push("AICB="+q),q=D.join("&"),x=window._dv_win.document.createElement("script"),
...
d;){if(b.parent.document.domain!=b.document.domain)return c.CrossDomain;b=b.parent;d++}return c.SameDomain}catch(e){}return c.CrossDomain};this.getVersionParamName=function(){return"jsver"};this.getVersion=function(){return"142"}};
